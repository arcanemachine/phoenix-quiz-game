defmodule QuizGameWeb.UserAuth do
  ...
  def logout_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      QuizGameWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule QuizGameWeb.PageLive do
        use QuizGameWeb, :live_view

        on_mount {QuizGameWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{QuizGameWeb.UserAuth, :ensure_authenticated}] do
